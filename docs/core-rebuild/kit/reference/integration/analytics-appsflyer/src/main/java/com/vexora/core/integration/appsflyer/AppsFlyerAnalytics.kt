...
import com.vexora.core.attribution.*
...
class AppsFlyerAnalytics @Inject constructor(@ApplicationContext private val context: Context,
    ...
    override fun event(name: String, parameters: Map<String, Any>) { AppsFlyerLib.getInstance().logEvent(context, com.vexora.core.analytics.AnalyticsPlatform.APPS_FLYER.eventName(name), parameters) }
