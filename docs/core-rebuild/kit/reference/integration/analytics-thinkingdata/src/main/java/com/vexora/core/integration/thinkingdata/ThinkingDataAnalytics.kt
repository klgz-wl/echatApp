package com.vexora.core.integration.thinkingdata
...
class ThinkingDataAnalytics @Inject constructor(@ApplicationContext private val context: Context,
    private val config: ThinkingDataConfig, private val policy: com.vexora.core.analytics.AnalyticsPolicy) : AnalyticsSink {
    ...
    override fun event(name: String, parameters: Map<String, Any>) { TDAnalytics.track(com.vexora.core.analytics.AnalyticsPlatform.THINKING_DATA.eventName(name), JSONObject(parameters)) }
