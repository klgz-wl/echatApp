...
import com.zorv.core.analytics.AnalyticsSink
...
class ThinkingDataAnalytics @Inject constructor(@ApplicationContext private val context: Context,
    private val config: ThinkingDataConfig, private val policy: com.zorv.core.analytics.AnalyticsPolicy) : AnalyticsSink {
    ...
    override fun event(name: String, parameters: Map<String, Any>) { TDAnalytics.track(com.zorv.core.analytics.AnalyticsPlatform.THINKING_DATA.eventName(name), JSONObject(parameters)) }
