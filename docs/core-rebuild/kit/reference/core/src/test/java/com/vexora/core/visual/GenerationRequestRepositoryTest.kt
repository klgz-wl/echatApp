...
import com.vexora.core.network.*
import java.io.File
...
class GenerationRequestRepositoryTest {
    ...
    private suspend fun fixture(events: com.vexora.core.analytics.EventTracker = com.vexora.core.analytics.NoOpEventTracker): Fixture {
    ...
    @Test fun `上传受理与生成终态分开记录且恢复轮询不重复终态`() = runBlocking {
        val events = com.vexora.core.analytics.RecordingTracker(); val f = fixture(events)
