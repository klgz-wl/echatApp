...
import com.vexora.core.attribution.LoginAttribution
...
interface AccountApi {
    @POST("auth/logout") suspend fun logout(@retrofit2.http.Tag session: com.vexora.core.auth.Session): ApiResponse<Unit>
    @POST("auth/delete-account") suspend fun deleteAccount(@retrofit2.http.Tag session: com.vexora.core.auth.Session): ApiResponse<Unit>
}
