...
object NetworkModule {
    @Provides @Singleton fun paymentStorage(value: com.vexora.core.payment.PreferencePaymentStorage): com.vexora.core.payment.PaymentStorage = value
    @Provides @Singleton fun paymentEvents(value: com.vexora.core.payment.PaymentEventQueue): com.vexora.core.payment.PaymentEventSink = value
    @Provides @Singleton fun paymentClock() = com.vexora.core.payment.PaymentClock { System.currentTimeMillis() }
    @Provides @Singleton fun paymentOrders(wallet: com.vexora.core.wallet.WalletRepository, config: com.vexora.core.billing.BillingConfiguration) =
        com.vexora.core.payment.PaymentOrderFactory { productId, session -> wallet.createOrder(productId, config.defaultTrigger, session).orderId }

    @Provides @Singleton fun paymentRepository(value: com.vexora.core.payment.ApiPaymentRepository): com.vexora.core.payment.PaymentRepository = value
    @Provides @Singleton fun paymentApi(@Named("publicClient") client: OkHttpClient, sessions: SessionCoordinator,
        api: PublicAuthApi, config: CoreRuntimeConfig, identity: ClientIdentity, json: Json): com.vexora.core.payment.PaymentServiceApi {
        ...
        return retrofit(paymentClient, config, json).create(com.vexora.core.payment.PaymentServiceApi::class.java)
    }
    ...
    @Provides @Singleton fun attributionReportApi(@Named("publicClient") client: OkHttpClient, config: CoreRuntimeConfig, json: Json): com.vexora.core.attribution.AttributionReportApi =
        retrofit(client, config, json).create(com.vexora.core.attribution.AttributionReportApi::class.java)
    @Provides @Singleton fun eventApi(@Named("publicClient") client: OkHttpClient, config: CoreRuntimeConfig, json: Json): com.vexora.core.analytics.EventApi =
        retrofit(client, config, json).create(com.vexora.core.analytics.EventApi::class.java)
    ...
    @Provides @Singleton fun uploadedPhotoApi(retrofit: Retrofit): com.vexora.core.visual.UploadedPhotoApi = retrofit.create(com.vexora.core.visual.UploadedPhotoApi::class.java)
    @Provides @Singleton fun photoDownloadApi(identity: ClientIdentity, config: CoreRuntimeConfig, json: Json): com.vexora.core.visual.UploadedPhotoDownloadApi =
        retrofit(OkHttpClient.Builder().connectTimeout(identity.timeoutSeconds, TimeUnit.SECONDS)
            ...
            .create(com.vexora.core.visual.UploadedPhotoDownloadApi::class.java)
    @Provides @Singleton fun visualApi(retrofit: Retrofit): com.vexora.core.visual.VisualGenerationApi = retrofit.create(com.vexora.core.visual.VisualGenerationApi::class.java)
    @Provides @Singleton fun walletApi(client: OkHttpClient, config: CoreRuntimeConfig, json: Json): com.vexora.core.wallet.WalletApi =
        retrofit(client.newBuilder().retryOnConnectionFailure(false).followRedirects(false).followSslRedirects(false).build(), config, json)
            .create(com.vexora.core.wallet.WalletApi::class.java)
