...
- For account edit-name Figma frames before profile persistence exists, represent the picker as an in-feature bottom sheet over the ME section with local selectable placeholder names and no storage/network side effects.
